...
//    private static String modelPackage = "com.leanit.module.article.model";
//    private static String servicePackage = "com.leanit.module.article.service";


    private static String moduleName = "page";
    private static String dbTables = "single_page";
    private static String modelPackage = "com.leanit.module.page.model";
    private static String servicePackage = "com.leanit.module.page.service";
