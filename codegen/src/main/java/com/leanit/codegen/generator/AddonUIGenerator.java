 ...
 */
package com.leanit.codegen.generator;
...
public class AddonUIGenerator {
    ...
    private String modulePackage;//com.leanit.module.product

    private String modelPackage;//com.leanit.module.product.model


    private String templatesDir = "com/leanit/codegen/templates/";
    ...
    public AddonUIGenerator(String basePath, String moduleName, String modelPackage, List<TableMeta> tableMetaList) {
        ...
        data.set("modulePackage", modulePackage);//com.leanit.module.product
        data.set("modelPackage", modelPackage);//com.leanit.module.product.model
        data.set("moduleListenerPakcage", moduleListenerPakcage);//com.leanit.module.product
        data.set("controllerPackage", controllerPackage);//com.leanit.module.product.controller
