...
VALUES
	(1, NULL, NULL, '欢迎使用LeanPress', '<p>欢迎使用 LeanPress，这是一篇 LeanPress 自动为您创建的测试文章，您可以进入 LeanPress 的后台，在文章管理里进行修改或者删除。</p>', 'html', NULL, NULL, NULL, NULL, 1, 0, 'normal', 1, 0, NULL, 1, '2019-09-01 12:00:00', '2019-09-01 12:00:00', NULL, NULL, NULL, NULL);
